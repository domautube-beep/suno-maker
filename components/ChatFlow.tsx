...
=== 레퍼런스 선정 기준 ===
절대 규칙: 주제가 비슷한 곡을 고르지 마. 프로덕션/사운드가 어울리는 곡을 골라라.
- 이 감정을 "소리로 표현하는 방식"이 유사한 곡 (편곡, 악기, 믹스 관점)
- 3곡의 장르/시대/질감이 서로 완전히 달라야 함 (같은 장르 2개 금지)
- BPM/시대/질감/리버브는 해당 곡의 실제 프로덕션 특성을 반영해라. 모르면 추정하되 정확하게.
