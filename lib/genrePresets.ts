...
export const GENRE_PRESETS: Record<string, GenrePreset> = {
  ...
  gospel: {
    ...
    texture: "spacious",
    reverb: "hall",
    style: "Gospel, powerful uplifting arrangement at 98 BPM with contemporary church production. Hammond B3 organ foundation with warm drawbar harmonics, Leslie speaker rotation creating wide stereo movement. Acoustic piano doubling chord progressions, subtle string pad layers filling upper register. Live drum kit with controlled room ambience, snare positioned center with subtle pre-delay reverb, kick drum tight and punchy. Bass guitar walking patterns anchoring root progressions. Electric guitar clean arpeggios with chorus effect, positioned wide for spatial depth. Large hall reverb architecture with long decay time, cathedral-like spaciousness. Verse sections stripped to organ and piano with light percussion, building tension through layering. Chorus explodes with full band, strings swelling, tambourine adding rhythmic brightness. Bridge drops to intimate piano and organ duet before final chorus crescendo with brass stabs and gospel chops. Emotional arc from contemplative worship through triumphant celebration to transcendent resolution.",
  },
  ballad: {
    tempo: "slow",
    timeSignature: "4/4",
  ...
  afrohouse: {
    ...
    texture: "analog_vintage",
    reverb: "room",
    style: "Afro House, percussive-driven groove at 122 BPM with African rhythmic DNA. Tribal drum patterns layered with electronic kick, shaker loops and djembe creating polyrhythmic texture. Deep warm bass synth with filter modulation, organic movement. Log drum or marimba melodic hooks weave through the percussion. Vocal chants and call-response patterns add cultural texture. Chorus builds with layered percussion and synth pad swells. Warm analog production with organic drum textures, deep sub bass presence, and wide percussive stereo field.",
  },
  ukgarage: {
    tempo: "fast",
    timeSignature: "4/4",
    ...
    texture: "clean_digital",
    reverb: "room",
    style: "UK Garage, syncopated 2-step groove at 130 BPM with shuffled rhythm. Tight kick with swung snare creating signature 2-step bounce. Chopped vocal samples pitched and timestretched. Warm sub bass with wobble modulation. Bright piano stabs and organ chords add harmonic movement. Hi-hats in complex syncopated patterns. Breakdown features filtered pads before the drop. Clean digital production with punchy low-end, crisp transients, and wide stereo vocal placement.",
  },
  deephouse: {
    tempo: "fast",
    timeSignature: "4/4",
    ...
    texture: "analog_vintage",
    reverb: "room",
    style: "Deep House, warm four-on-the-floor groove at 122 BPM with soulful character. Warm analog kick with deep sustained bass note movement. Soulful piano chords and Rhodes voicings add jazzy harmonic color. Subtle percussion layers with shaker and ride cymbal. Atmospheric pad textures create depth between sections. Filtered synth stabs add rhythmic punctuation. Vocal snippets and processed textures float above the groove. Warm analog feel with deep bass presence, soft compression, and lush spatial depth.",
  },
  melodichouse: {
    tempo: "fast",
    timeSignature: "4/4",
    ...
    texture: "clean_digital",
    reverb: "hall",
    style: "Melodic House, emotional progressive groove at 124 BPM with building energy. Driving four-on-the-floor kick with layered percussion and ride cymbal. Arpeggiated synth sequences create hypnotic melodic patterns. Warm pad layers build through long filter sweeps. Pluck synth melodies carry the emotional hook. Bass synth with sidechain compression creates pumping groove. Breakdown builds tension with rising pads and reversed textures before climactic drop. Clean production with wide stereo field, deep sub bass, and emotional melodic presence.",
  },
  bossanova: {
    tempo: "mid_slow",
    timeSignature: "4/4",
